      ...
      <section className="rounded-2xl border border-gray-200 bg-white dark:bg-black px-6 py-5">
        <div className="flex flex-col gap-6 md:flex-row md:items-start md:gap-10">
          ...
          <div className="md:w-56 space-y-1.5">
            <h2 className="text-[13px] font-medium text-gray-900">Auto Router</h2>
          ...
          <div className="flex-1 space-y-5">
            ...
            <div className="space-y-1.5">
              ...
              <textarea
                ...
                rows={5}
                className="w-full resize-none rounded-lg border border-gray-200 bg-[#F9FAFB] px-3 py-2 text-[12px] text-gray-800 placeholder:text-gray-400 focus:border-gray-300 focus:outline-none focus:ring-1 focus:ring-[#A5B4FC]"
              />
              <div className="flex items-center justify-between text-[11px] text-gray-400">
                <p>
                  ...
                  wildcards like <code className="rounded bg-gray-100 px-1">anthropic/*</code>.
                </p>
                <button
                  type="button"
            ...
            <div className="flex flex-col items-start justify-between gap-3 border-t border-gray-100 pt-4 text-[12px] text-gray-600 md:flex-row md:items-center">
              <button
                type="button"
        ...
        <div className="flex flex-col gap-4 md:flex-row md:items-center md:justify-between">
          ...
          <div className="w-full max-w-xs">
            <Select value={providerSort} onValueChange={setProviderSort}>
              <SelectTrigger className="h-10 w-full rounded-lg border border-gray-200 bg-[#F9FAFB] text-[12px] text-gray-800 focus:border-gray-300 focus:ring-1 focus:ring-[#A5B4FC]">
